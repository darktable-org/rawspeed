...
add_custom_target(
  coverage-show
  DEPENDS rstest
  COMMAND "${LLVMCOV_PATH}" show -Xdemangler="${CPPFILT_PATH}" -instr-profile "${CMAKE_BINARY_DIR}/rawspeed.profdata" "$<TARGET_FILE:rstest>" -format html -output-dir "${CMAKE_BINARY_DIR}/coverage"
